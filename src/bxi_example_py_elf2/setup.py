...
package_name = 'bxi_example_py_elf2'
...
setup(
    ...
    entry_points={
        'console_scripts': [
            'bxi_example_py_elf2 = bxi_example_py_elf2.bxi_example:main',
            'bxi_example_py_elf2_run = bxi_example_py_elf2.bxi_example_run:main',
            'bxi_example_py_elf2_walk = bxi_example_py_elf2.bxi_example_walk:main',
        ],
    },
)
